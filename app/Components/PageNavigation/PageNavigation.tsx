...
const PageNavigation = () => {
  return (
    <div className='flex flex-col justify-between items-center border-2 p-4 list-none gap-2 w-full '>
        <a className="bg-gray-600 text-white p-2 px-4 rounded-lg" href="/"><li>Home</li></a>
        ...
        <a className="bg-gray-600 text-white p-2 px-4 rounded-lg" href="/debate/all"><li>Debate</li></a>
        {/* <a href=""><li></li></a> */}
