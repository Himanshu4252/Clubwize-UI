...
import { Cross, proImage, CoverPhoto, Colon, NodeOne, NodeTwo, NodeThree, NodeFour, Online } from '../photos'
...
const UserProfile:UserProfiles[] =[
  {
    ...
    isOnline: false,
    userName:'Vichithram design studio',
    userProfession:'Design agency',
