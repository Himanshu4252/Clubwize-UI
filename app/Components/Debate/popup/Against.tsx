...
export default function Against({ isOpen, onClose}: ModuleProps) {
  ...
  const handleButtonClick = (e: React.MouseEvent<HTMLButtonElement>) => {
    e.preventDefault();
    if (imageUploaded) {
       window.location.href ="/debate/against";
    }
  };
    ...
    <div className="fixed inset-0 bg-gray-800 bg-opacity-75 flex justify-center items-center z-50">
      <div className="bg-white p-10 rounded-lg overflow-hidden shadow-xl transform transition-all sm:max-w-lg sm:w-full">
        <div className="flex justify-between items-center mb-1">
          <h2 className="text-2xl font-medium text-gray-700">Add new Against point</h2>
